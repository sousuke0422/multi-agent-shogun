...
| Toolchain/runtime/global package install needed (D011-AT) | STOP. Report what / why / version / method / source URL. Wait for approval before installing. Record package, version, URL, command, and install path in report if approved. |
