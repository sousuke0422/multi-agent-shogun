...
- The `.claude/settings.json` `attribution` field handles this automatically for commits in the shogun repository itself. For external repos, add the trailer manually in the commit message.
